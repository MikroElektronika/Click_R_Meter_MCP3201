 ...
 * <a href="http://www.mikroe.com">MikroElektronika's</a> R Meter click
 * board.
 */
...
/**
 * @brief <h3> R Meter Get Volts </h3>
 *
 * @par
 * Gets voltage reading from SPI
 *
 * @param[out] voltage - uint16_t voltage reading from SPI
 */
uint16_t r_meter_get_volts( void );
/**
 * @brief <h3> R Meter Get OHMS </h3>
 *
 * @par
 *  Returns OHMS after taking average of voltage from R Meter Click
 *
 * @param[out] ohms - float ohms value from R Meter Click
 */
